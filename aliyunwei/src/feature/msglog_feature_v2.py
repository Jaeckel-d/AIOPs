...
wc_from_word_count(wordDict, './wordcloud.png')
...
msg_feature_train['msg_feature'] = msg_feature_train.apply(lambda x: seqfilter(x.time_seq, x.msg_seq, x.fault_time),
                                                           axis=1)
msg_feature_test_a['msg_feature'] = msg_feature_test_a.apply(lambda x: seqfilter(x.time_seq, x.msg_seq, x.fault_time),
                                                             axis=1)
msg_feature_test_b['msg_feature'] = msg_feature_test_b.apply(lambda x: seqfilter(x.time_seq, x.msg_seq, x.fault_time),
                                                             axis=1)
